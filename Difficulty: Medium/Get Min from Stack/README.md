<h2><a href="https://www.geeksforgeeks.org/problems/get-minimum-element-from-stack/1?page=1&category=Tree,Stack,Searching,Binary%20Search%20Tree,Queue&difficulty=Medium&status=unsolved&sortBy=submissions">Get Min from Stack</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18.6667px;">Implement a class&nbsp;<strong>SpecialStack</strong>&nbsp;that supports following operations:</span></p>
<ul>
